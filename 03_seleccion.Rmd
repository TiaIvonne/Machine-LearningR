...
las features que son mas relevantes para el posterior proceso de modelamiento y
...
Según el código anterior, las variables mas relevantes seleccionadas son:
...
fuente en el siguiente repositorio: <https://github.com/TiaIvonne/MasterUCM-MachineLearningR/blob/master/h2o%20python/autoML_dengue.ipynb>

\tiny

```{r eval=TRUE, echo=TRUE, out.width="70%", fig.align = 'center', results='hide'}
...
-   El modelo de Logistica1 entrega mejores resultados que el modelo2
