...
evaluar bajo la funcion "cruzadas ensamblado binaria fuente.R".
...
# Se ha omitido el resto del codigo
```

\normalsize

Con la función genera graficos y una vez calculadas las medias en el proceso
anterior se obtiene el grafico de cajas respectivo: \tiny
...
predi3 etc se crean los ensamblados. Solo se adjunta una muestra del codigo
...
Solo se adjunta una parte del codigo, se construyen los promedios de tasa de
fallos y AUC.
...
-   De los modelos originales los mejores resultados observando el grafico los
...
-   El *accuracy* alcanzado por los ensamblados es mas alto si se compara con
    ...
    estaria mostrando mejores resultados que los ensamblados.
-   La tasa de fallos vs el auc muestra algunas incoherencias, en tasa de fallos
    ...
    predi55 y predi57 respectivamente estan a la cabecera de los resultados.
